...
entries=[]
for page in (root/'data/catalog').glob('page-*.json'):
...
draw.text((48,135),f'{count} sequences.',font=font(43),fill='#e5ebf6')
draw.text((48,198),'A shared lens.',font=font(43),fill='#e5ebf6')
draw.text((48,310),'weight × level + jump',font=font(24),fill='#aabdd8')
draw.text((48,389),f'{points/1000000:g} million computed points',font=font(20),fill='#e5ebf6')
...
im.save(root/f'assets/social-card-atlas-{count}.png',optimize=True)
